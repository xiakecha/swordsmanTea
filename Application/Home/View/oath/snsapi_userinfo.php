...
//	echo "nickname is :".$nickname;
	...
	header("Location:"."http://112.74.86.188/km_data_center/kmi/Application/Home/Controller/DB.php?openid=$openid&access_token=$access_token&nickname=$nickname");
	exit;
//	$follower = M('follower');
//	$data['openid'] = $openid;
...
//	$follower->add($data);
//	
//	header("Location:"."start.php?openid=$openid&access_token=$access_token");
